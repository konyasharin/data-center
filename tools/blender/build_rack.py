...
def make_server(units=1, name=None):
	...
	# The inlets and the network port. Without them a cord arriving at the back of a
	# server ends against a flat panel, which is exactly what it looks like: a cable
